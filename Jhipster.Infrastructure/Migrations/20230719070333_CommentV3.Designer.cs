...
namespace Jhipster.Infrastructure.Migrations
{
    ...
    [Migration("20230719070333_CommentV3")]
    partial class CommentV3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Post.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<string>("BoughtPostId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Post.Domain.Entities.FakeNew", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Post.Domain.Entities.NewPost", b =>
                {
                    ...
                    b.Property<string>("descriptionForList")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Post.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<List<string>>("ListBanner")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.PriceConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TypePriceId");

                    b.ToTable("PriceConfigurations");
                });

            modelBuilder.Entity("Wallet.Domain.Entities.TermConditionConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("TypeTermId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("TypeTermId");

                    b.ToTable("TermConditionConfigurations");
                });
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.TypePrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.TypeTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.TermConditionConfiguration", b =>
                {
                    b.HasOne("Wallet.Domain.Entities.TypeTerm", "TypeTerm")
                        .WithMany("TermConfig")
                        .HasForeignKey("TypeTermId");

                    b.Navigation("TypeTerm");
                });
